...
/**
 * WPEM_Sms_Notifications_Writepanels class.
 */
if ( class_exists( 'WP_Event_Manager_Writepanels' ) ) 
{
	class WPEM_Sms_Notifications_Writepanels extends WP_Event_Manager_Writepanels {
	...
	new WPEM_Sms_Notifications_Writepanels();
}
