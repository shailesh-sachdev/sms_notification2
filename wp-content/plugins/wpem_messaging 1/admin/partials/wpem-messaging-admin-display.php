...
?>
    ...
    <input type="text" name="sid" id="" style="width:450px;" value="<?php echo get_option('sid')?>">
    <br>
    <div style="height:30px; margin-top:20px;">
    <label for="auth" style="font-size:25px;">Auth </label>
    </div>
    <input type="text" name="auth" id="" style="width:450px;" value="<?php echo get_option('auth')?>">
    <br>
    <div style="height:30px; margin-top:20px;">
    <label for="auth" style="font-size:25px;">Phone Number Aloted to you By Twilio</label>
    </div>
    <input type="text" name="phone" id="" style="width:450px;" value="<?php echo get_option('phone')?>">
    <br>
    <br>
