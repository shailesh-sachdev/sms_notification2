...
if(!function_exists('license_manage_menu'))
{
	...
	{
		add_submenu_page(  'edit.php?post_type=event_listing', __( 'License', 'wpem-pluginslug' ),  __( 'License', 'wpem-pluginslug' ) , 'manage_options', 'license','wpem_manage_license' );
	}
}
...
if(!function_exists('wpem_manage_license'))
{
	function wpem_manage_license() 
	{
		...
		<div class="wrap wpem-updater-licence-wrap">
			<h2><?php _e('License', 'wpem-pluginslug'); ?></h2>
			...
			<div class="notice notice-info inline"><p><?php _e('Lost your license key?', 'wpem-pluginslug'); ?> <a target="_blank" href="//wp-eventmanager.com/lost-license-key/"><?php _e('Retrieve it here', 'wpem-pluginslug'); ?></a>.</p></div>
		</div>
