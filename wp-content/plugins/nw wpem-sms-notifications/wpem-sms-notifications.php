<?php
/**
Plugin Name: WP Event Manager - SMS Notifications
Plugin URI: https://www.wp-eventmanager.com
Description: This plugin gives you the feature of sending SMS.
	...
	*/
	if ( !is_plugin_active( 'wp-event-manager/wp-event-manager.php') ) 
	{
    	...
    	if( $pagenow == 'plugins.php' )
    	{
           ...
           echo __( 'WP Event Manager is require to use WP Event Manager Plugin SMS Notifications' , 'wpem-sms-notifications');
           echo '</p></div>';	
    	}
    	return true;
	}
...
class WP_Event_Manager_Sms_Notifications extends WPEM_Updater{
	...
	/**
	 * Main WP Event Manager Sms_Notifications Instance.
	 *
...
function WPEM_Sms_Notifications() { 
	...
	*/
	...
	add_action( 'admin_init', $plugin_admin, 'register_credentials');
}
